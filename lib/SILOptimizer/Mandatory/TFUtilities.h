...
static const char DEFAULT_CPU_DEVICE[] = "/job:localhost/replica:0/task:0/device:CPU:0";
static const char DEFAULT_GPU_DEVICE[] = "/job:localhost/replica:0/task:0/device:GPU:0";
static const char DEFAULT_TPU_DEVICE[] = "/job:localhost/replica:0/task:0/device:TPU:0";
